...
/*   Updated: 2020/02/25 06:08:04 by llachgar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define CHECK_PATH_CONTEXT1(p) (!ft_strcmp(p, "..") || !ft_strcmp(p, "."))
# define CHECK_PATH_CONTEXT(p) (ft_strrchr(p, '/') || CHECK_PATH_CONTEXT1(p))
# define IS_BEGIN_CMD(c) (c == ';' || c == '|' || c == '&')
# define BUFF_LINE 1

enum {BINARY, VARS, PATH};
enum {POINT, NUMBER};
...
** ft_select(42)
*/
void				print_matches(t_data *matches, t_cmd *l,
